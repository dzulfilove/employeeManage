    ...
    <div>
      ...
      <div className="w-[100%] flex justify-between items-center  text-2xl font-semibold  p-2 py-6 rounded-xl">
        <div
          data-aos="fade-down"
          data-aos-delay="50"
          className="flex  card-eks flex-col relative justify-center items-start gap-1 w-[32rem] h-[15rem]  bg-transparent overflow-hidden border-l-8 border-l-red-500 rounded-md  hover:bg-slate-800 shadow-xl"
        >
          <div className="content-eks flex flex-col absolute justify-center items-start gap-1 w-[32rem] h-[15rem] opacity-75 bg-slate-800 overflow-hidden rounded-md shadow-lg "></div>
        ...
        <div
          data-aos="fade-down"
          data-aos-delay="250 "
          className="flex card-eks  flex-col relative justify-center items-start gap-1 w-[32rem] h-[15rem]  bg-transparent overflow-hidden border-l-8 border-l-yellow-500 rounded-md shadow-lg "
        >
          <div className=" content-eks flex flex-col absolute justify-center items-start gap-1 w-[32rem] h-[15rem] opacity-75 bg-slate-800 overflow-hidden rounded-md shadow-lg "></div>
        ...
        <div
          data-aos="fade-down"
          data-aos-delay="350"
          className=" card-eks flex  flex-col relative justify-center items-start gap-1 w-[32rem] h-[15rem]  bg-transparent overflow-hidden border-l-8 border-l-emerald-500 rounded-md shadow-lg "
        >
          <div className="content-eks flex flex-col absolute justify-center items-start gap-1 w-[32rem] h-[15rem] opacity-75 bg-slate-800 overflow-hidden rounded-md shadow-lg "></div>
