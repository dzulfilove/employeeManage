...
const DropdownSearch = ({ options, change, value }) => {
  ...
  return (
    <div className="relative w-full">
      ...
      >
        {selectedOption ? selectedOption.text : "Pilih Divisi.."}
      </div>
      {showOptions && (
        <div className="absolute w-full glass-effect border border-gray-300 rounded mt-1 z-10 p-2">
          <input
            type="text"
