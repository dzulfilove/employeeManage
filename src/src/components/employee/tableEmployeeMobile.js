...
function TableEmployeeMobile(props) {
    ...
    >
      ...
      <div className="xl:hidden flex ">
        <table
          data-aos="fade-up"
          data-aos-delay="550"
          className="w-[100%] text-left text-xs font-normal"
        >
          <thead>
            <tr className="bg-slate-700 text-slate-300 rounded-xl font-normal py-6 w-full">
              ...
              <th className="px-4 py-4 font-medium ">Sisa Kontrak</th>
            ...
            {props.getData == false ? (
              <>
                <tr className="hover:cursor-pointer">
                  <td className="border-b border-blue-gray-300 h-[4rem] max-h-[1rem] w-[1%] px-4 py-2 text-white"></td>

                  <td className="border-b border-blue-gray-300 h-[4rem] max-h-[1rem] px-4 py-2 w-[1%] text-white"></td>
