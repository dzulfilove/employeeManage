...
export default function CardEmployee(props) {
  return (
    <div>
      {" "}
      <div className="w-[100%] sm:text-lg flex justify-between items-center  text-2xl font-semibold  p-2 py-6 rounded-xl">
        <div
          data-aos="fade-down"
          data-aos-delay="50"
          className="flex  card flex-col relative justify-center items-start gap-1 w-[20rem] h-[15rem] sm:w-[14rem] sm:h-[14rem] bg-transparent overflow-hidden border-l-8 border-l-red-500 rounded-md  hover:bg-slate-800 shadow-xl"
        >
          <div className="content flex flex-col sm:w-[14rem] sm:h-[6rem] absolute justify-center items-start gap-1 w-[25rem] h-[15rem] opacity-75 bg-slate-800 overflow-hidden rounded-md shadow-lg "></div>
          <div className="w-[8rem] h-[8rem] sm:w-[5rem] sm:h-[5rem] opacity-35 rounded-full blur-2xl bg-red-400 absolute right-[5%] top-[5%]"></div>
        ...
        <div
          data-aos="fade-down"
          data-aos-delay="150"
          className="xl:flex card hidden flex-col relative justify-center items-start gap-1 w-[25rem] h-[15rem]  bg-transparent overflow-hidden border-l-8 border-l-blue-500 rounded-md shadow-lg "
        >
