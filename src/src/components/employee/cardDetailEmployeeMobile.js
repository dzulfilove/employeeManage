...
function CardDetailEmployeeMobile(props) {
  ...
  return (
    <div className="flex w-full  justify-center items-center bg-slate-800">
      <div
        data-aos="fade-down"
        data-aos-delay="50"
      ...
      >
        ...
        <div className="w-[100%] flex flex-col xl:flex-row  justify-between items-start pb-8   rounded-lg relative playing  overflow-hidden shadow-xl mb-6">
          <div
            data-aos="fade-down"
            data-aos-delay="250"
                ...
                >
                  ...
                  <div className="w-full gap-2 flex justify-between items-start p-2">
                    ...
                    <div className="w-[50%] gap-2 flex flex-col justify-start items-start p-2">
                      ...
                      <textarea
                        className="w-full p-2 text-sm bg-slate-700 text-white border-slate-500 border rounded-lg min-h-[3rem] h-[10rem] resize-none font-normal"
                        value={alamat}
                        onChange={(e) => {
                ...
                >
                  ...
                  <div className="w-full gap-2 flex justify-between items-start p-2">
                    ...
                    <div className="w-[50%] gap-2 flex flex-col justify-start items-start p-2">
                      <h4 className="font-semibold text-sm">Alamat</h4>
                      <div
                        className={`w-full p-2 text-white border text-sm rounded-lg min-h-[3rem] h-[10rem] resize-none font-normal ${
                          props.data.alamat
                            ? "bg-slate-700 border-slate-500"
                            : "text-red-500 border-red-600"
                        }`}
...
export default CardDetailEmployeeMobile;
