...
import TableEmployeeMobile from "../../components/employee/tableEmployeeMobile";
  ...
  render() {
    return (
      <div className=" bg-slate-800 pt-24">
        ...
        /> */}
        <div className="flex justify-start flex-col w-full items-center text-md bg-slate-800 overflow-x-hidden">
