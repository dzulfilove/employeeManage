...
import CardDetailEmployeeMobile from "../../components/employee/cardDetailEmployeeMobile";
import TableEmployeeDetailMobile from "../../components/employee/tableEmployeeDetailMobile";
class EmployeeDetailMobile extends Component {
  constructor(props) {
    super(props);
...
export default withRouter(EmployeeDetailMobile);
